...
# Explicitly set the database URL from environment
...
import re
database_url = re.sub(r'[?&]ssl=([^&]+)', r'?sslmode=\1', database_url)
# If there's no ssl parameter but it's needed, remove any incompatible ssl params
